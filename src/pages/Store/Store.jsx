        ...
        <>
            ...
            <div className="container-items">
                ...
                <div className="item">
                    <figure>
                        <img
                            src={vaca1} // Usar la imagen de la vaca1
                            alt="vaca1" // Cambiar el alt a "vaca1"
                        />
                    </figure>
                    <div className="info-product">
                        <h2>Vaca Lechera</h2> {/* Cambiar el nombre del producto */}
                        <p className="price">$800.000</p> {/* Cambiar el precio */}
                        <p className="desc">Puede dar hasta 50 litros diarios</p> {/* Cambiar el precio */}
